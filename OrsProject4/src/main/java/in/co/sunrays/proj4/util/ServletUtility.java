 ...
 * redirect, handle generic exception, manage success and error message,
...
*/
    ...
    public static int getPageNo(HttpServletRequest request) {
    	...
    	Integer i= (Integer) request.getAttribute("pageNo");
    	return   i.intValue();
    }
    ...
    Integer	i=(Integer) request.getAttribute("pageSize");
    	return   i.intValue();
    }
