...
public class StudentCtl extends BaseCtl {
    ...
    protected boolean validate(HttpServletRequest request) {
        ...
        if (DataValidator.isNull(request.getParameter("firstName"))) {
            ...
            request.setAttribute("firstName",
                    PropertyReader.getValue("error.fname", "First Name"));
            pass = false;
        }
        ...
        if (DataValidator.isNull(request.getParameter("lastName"))) {
            ...
            request.setAttribute("lastName",
                    PropertyReader.getValue("error.lname", "Last Name"));
            pass = false;
        }
        if (DataValidator.isNull(request.getParameter("mobileNo"))) {
            ...
            request.setAttribute("mobileNo",
                    PropertyReader.getValue("error.mono", "Mobile No"));
            pass = false;
        }
        ...
        if (DataValidator.isNull(request.getParameter("collegeId"))||request.getParameter("collegeId").toString().trim().equals("")) {
